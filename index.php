...
$data_inicio = [
    "images" => true,
    "filter" => ["contenidos.area IN ('inicio','galeria-principal')"]
];
    ...
    <section id="clients" class="clients section-bg">
        <div class="container">
            <div class="row" data-aos="zoom-in">
                <?php foreach ($inicio["marcas-inicio"]["images"] as $key => $item) { ?>
    ...
    <section id="why-us" class="why-us section-bg">
        <div class="container-fluid" data-aos="fade-up">
            <div class="row">
                ...
                <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("<?= $preguntas_frecuentes["faq-inicio"]["images"][0]["url"] ?>");' data-aos="zoom-in" data-aos-delay="150">&nbsp;
                </div>
            </div>
        </div>
